...
# -*- coding: utf-8 -*-
#
# MinVar documentation build configuration file, created by
# sphinx-quickstart on Thu Feb  8 09:52:30 2018.
#
...
project = 'MinVar'
copyright = '2018, Osvaldo Zagordi'
...
latex_documents = [
    (master_doc, 'MinVar.tex', 'MinVar Documentation',
     'Osvaldo Zagordi', 'manual'),
]
...
man_pages = [
    (master_doc, 'minvar', 'MinVar Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MinVar', 'MinVar Documentation',
     author, 'MinVar', 'One line description of project.',
     'Miscellaneous'),
]
